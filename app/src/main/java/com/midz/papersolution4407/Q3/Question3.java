package com.midz.papersolution4407.Q3;
...
public class Question3 extends AppCompatActivity {
    ...
    private Typeface[] font_typefaces = {
            Typeface.SANS_SERIF,
            Typeface.MONOSPACE,
            Typeface.DEFAULT
    };
...
//Mids
    ...
    private void changetext() {
        if (selectedTypeFace != 3) {
            Hellotxt.setTypeface(font_typefaces[selectedTypeFace]);
            selectedTypeFace++;
        } else {
            selectedTypeFace = 0;
        }
    ...
    private void changecolor() {
        if (selectedColor != 6) {
            Hellotxt.setTextColor(getColor(colour[selectedColor]));
            selectedColor++;
        } else {
            selectedColor = 0;
        }
